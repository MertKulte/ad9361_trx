...
set _xil_proj_name_ "ad9361_project"
...
#set_property -name "ip_output_repo" -value "e:/viv/okul/ad9361_rec/projects/fmcomms2/zed/${_xil_proj_name_}.cache/ip" -objects $obj
set_property -name "legacy_ip_repo_paths" -value "" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "project_type" -value "Default" -objects $obj
set_property -name "pr_flow" -value "0" -objects $obj
#set_property -name "sim.central_dir" -value "e:/viv/okul/ad9361_rec/projects/fmcomms2/zed/${_xil_proj_name_}.ip_user_files" -objects $obj
...
set obj [get_filesets sources_1]
set files [list \
 "$origin_dir/../src/ad_iobuf.v" \
 "$origin_dir/../src/system_wrapper.v" \
]
add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
set files [list \
 "$origin_dir/../src/system/system.bd"\
 "$origin_dir/../src/system_top.v"\
]
...
#set file "blk_mem_gen_0/tx_siggen_blkmem.coe"
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "is_enabled" -value "1" -objects $file_obj
#set_property -name "is_global_include" -value "0" -objects $file_obj
#set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "[file normalize "$origin_dir/../src/system_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "src/system_constr.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../src/zed_system_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "src/zed_system_constr.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
#set file "[file normalize "$origin_dir/E:/viv/okul/ad9361_rec/projects/fmcomms2/zed/fmcomms2_zed.srcs/constrs_1/new/constr.xdc"]"
#set file_added [add_files -norecurse -fileset $obj [list $file]]
...
set_property -name "target_constrs_file" -value "[get_files src/system_constr.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files src/system_constr.xdc]" -objects $obj
